...
class CCKind(str, Enum):
    ...
    BIG_SYM = "big_sym"  # Phase 2+ (reserved)
    V_CHAR_STACK = "v_char_stack"  # Phase 2 vertical stack (planet + specks)
    FLOATER_BLOB = "floater_blob"  # Phase 2 survivor not mergeable into text runs
